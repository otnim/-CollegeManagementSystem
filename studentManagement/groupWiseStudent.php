...
if(isset($_POST['submit'])){
  $batch = $_POST['batch'];
  $group = $_POST['group'];
  $queryString = "SELECT * FROM college_management1.students s WHERE s.group = '$group' and s.batch = $batch;";
...
?>
    ...
    <h2 class="d-flex justify-content-center">Group Wise Student</h2>
